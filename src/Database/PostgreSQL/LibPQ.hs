...
enterPipelineMode :: Connection
                  -> IO Bool
enterPipelineMode connection = ifEnabledPipeline $ enumFromConn connection c_PQenterPipelineMode
...
exitPipelineMode :: Connection
                 -> IO Bool
exitPipelineMode connection = ifEnabledPipeline $ enumFromConn connection c_PQexitPipelineMode
...
pipelineSync :: Connection
             -> IO Bool
pipelineSync connection = ifEnabledPipeline $ enumFromConn connection c_PQpipelineSync
...
sendFlushRequest :: Connection
                 -> IO Bool
sendFlushRequest connection = ifEnabledPipeline $ enumFromConn connection c_PQsendFlushRequest
